...
<a id="Footnote 1"></a>Which, all these years later begs the question, "If the file system was read only, how did you update the script you were supposed to be changing?" Let's not let details get in the way of a good story, shall we?
